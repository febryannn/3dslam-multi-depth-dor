...
: ${AMENT_CURRENT_PREFIX:="/home/febryan/agv_ros2_ws/src/mapping/install/mapping"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mapping/environment/pythonpath.sh"
